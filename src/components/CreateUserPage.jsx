...
function CreateUserPage() {
    ...
    return (
      ...
      <input name="fullName" placeholder="Full Name" onChange={handleChange} className="text-black" required />
      <input name="email" placeholder="Email" onChange={handleChange} className="text-black" required />
